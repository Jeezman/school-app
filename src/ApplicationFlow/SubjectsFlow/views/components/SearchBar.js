...
import AutoSelect from "../../../components/simple/AutoSelect";
import styled from "styled-components";
import globals from "../../../siteStyle";
import Media from "react-media";
import { allSubjects, ADD_SUBJECTS } from "../SubjectSelectPage/reducers";
import Input from "../../../components/simple/Input";
import StandaloneSearchInput from "../../../components/form/SearchInputComponent";
const { xs } = globals;
...
const SearchBar = ({
  ...
  const newOnSelect =
    onSelect ||
    function(value) {
      dispatch({ type: ADD_SUBJECTS, value });
    };
